...
<b>UserControl Pro</b> is a website where users can register, and only registered users ca see the list of registered users. The users can also block, unblock or delete other user's data. Front end is done with React JS and back end is done with RoR.
